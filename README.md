...
The goal of this course is to give you a brief introduction to GitHub. We’ll also provide you with materials for further learning and a few ideas to get you started on our platform. 🚀 See tasks at the end of this readme file - see next steps.
...
📝 Next steps
Create a new markdown file in this repository - called "ABOUTME.md". Tell your teacher a bit more about you. Use Markdown syntax to format your document. See the SAMPLE.md file in this repo for examples of what to include!
